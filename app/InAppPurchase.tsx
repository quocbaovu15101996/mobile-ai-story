      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.planBoxWrapper}>
          ...
          >
            ...
            <Text style={styles.planPrice}>999.000 đ <Text style={styles.planPeriod}>/ year</Text></Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Text style={[styles.planPrice, { color: '#bbb' }]}>125.000 đ <Text style={styles.planPeriod}>/ week</Text></Text>
          </TouchableOpacity>
        </View>
